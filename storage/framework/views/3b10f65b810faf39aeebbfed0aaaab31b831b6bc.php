        ...
        <div class='BlockSetting mt-4'>
            ...
            <div class="mb-5">
                ...
                <div class="list-my-group">
                    ...
                    <form action="<?php echo e(route('destroy_user', $account->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('Controller_settings')); ?>">
            ...
            <div>
                ...
                <div class="list-my-group">
                    ...
                    <form action="<?php echo e(route('message_destroy', $message->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                ...
                <form action="<?php echo e(route('add_message_route')); ?>" method="GET">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\work\projects\Kuch\resources\views/page/setting_page.blade.php ENDPATH**/ ?>